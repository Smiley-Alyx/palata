...
| Sprite animations (idle/attack/death) | `assets/animations/**/*.json` + `src/game/render/animations.ts` | partial (рантайм регистра и frame-cycle готов; мульти-кадровых артов пока нет) |
