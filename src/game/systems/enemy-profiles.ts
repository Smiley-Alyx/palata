...
const DEFORMED: EnemyProfile = {
  ...
  speedPatrol: 0.55,
  speedChase: 0.8,
  sightLoop: SFX.enemies.deformedPatient.idle,
  attack: SFX.enemies.deformedPatient.attack,
  hurt: SFX.enemies.deformedPatient.hurt,
  death: SFX.enemies.deformedPatient.death,
  damage: {
    lost: { min: 12, max: 18 },
...
const FLESH_WATCHER: EnemyProfile = {
  ...
  speedPatrol: 0.5,
  speedChase: 0.85,
  sightLoop: SFX.enemies.fleshWatcher.idle,
  attack: SFX.enemies.fleshWatcher.attack,
  hurt: SFX.enemies.fleshWatcher.hurt,
  death: SFX.enemies.fleshWatcher.death,
  damage: {
    lost: { min: 8, max: 14 },
...
const FLESH_EYE: EnemyProfile = {
  ...
  speedPatrol: 0.0,
  speedChase: 0.0,
  sightLoop: SFX.enemies.fleshEye.idle,
  attack: SFX.enemies.fleshEye.attack,
  hurt: SFX.enemies.fleshEye.hurt,
  death: SFX.enemies.fleshEye.death,
  damage: {
    lost: { min: 6, max: 10 },
...
const FLESH_MACHINE: EnemyProfile = {
  ...
  speedPatrol: 0.4,
  speedChase: 0.7,
  sightLoop: SFX.enemies.fleshMachine.idle,
  attack: SFX.enemies.fleshMachine.attack,
  hurt: SFX.enemies.fleshMachine.hurt,
  death: SFX.enemies.fleshMachine.death,
  damage: {
    lost: { min: 18, max: 28 },
...
const DOPPELGANGER: EnemyProfile = {
  ...
  speedPatrol: 0.75,
  speedChase: 1.1,
  sightLoop: SFX.enemies.doppelganger.idle,
  attack: SFX.enemies.doppelganger.attack,
  hurt: SFX.enemies.doppelganger.hurt,
  death: SFX.enemies.doppelganger.death,
  damage: {
    lost: { min: 20, max: 30 },
    trapped: { min: 22, max: 34 },
...
const BOSS_CHOIR: EnemyProfile = {
  ...
  speedPatrol: 0.35,
  speedChase: 0.6,
  sightLoop: SFX.bosses.choir.intro,
  attack: SFX.bosses.choir.attack,
  hurt: SFX.bosses.choir.hurt,
  death: SFX.bosses.choir.death,
  damage: {
    lost: { min: 24, max: 32 },
...
const BOSS_DADE_KEEPER: EnemyProfile = {
  ...
  speedPatrol: 0.5,
  speedChase: 0.9,
  sightLoop: SFX.bosses.dadeKeeper.intro,
  attack: SFX.bosses.dadeKeeper.attack,
  hurt: SFX.bosses.dadeKeeper.hurt,
  death: SFX.bosses.dadeKeeper.death,
  damage: {
    lost: { min: 26, max: 36 },
...
const BOSS_SHEPHERD: EnemyProfile = {
  ...
  speedPatrol: 0.9,
  speedChase: 1.3,
  sightLoop: SFX.bosses.shepherd.intro,
  attack: SFX.bosses.shepherd.attack,
  hurt: SFX.bosses.shepherd.hurt,
  death: SFX.bosses.shepherd.death,
  damage: {
    lost: { min: 26, max: 38 },
