...
const DEFS: Record<WeaponId, WeaponDef> = {
  skalpel: {
    ...
    ammoId: null,
    range: 1.25,
    fireSfx: SFX.weapons.scalpel.swing,
    emptySfx: null,
    hitFleshSfx: SFX.weapons.scalpel.hitFlesh,
    hitWallSfx: SFX.weapons.scalpel.hitBone,
    cooldownMs: 300,
    damage: 0.5,
    flash: false,
    noiseRadius: 2.5,
    spreadRad: degToRad(10),
    hitHalfAngleRad: degToRad(32),
  },
  pipe: {
    id: 'pipe',
    label: 'PIPE',
