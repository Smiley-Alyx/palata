...
export const SFX = {
  ...
  hallucinations: {
    ...
    attack01: 'hallucination.attack.01',
    attack02: 'hallucination.attack.02',
    attack03: 'hallucination.attack.03',
    attack04: 'hallucination.attack.04',
    attack05: 'hallucination.attack.05',
    nearby: 'hallucination.nearby',
    manifest: 'hallucination.manifest',
    whiteFigure: {
...
export const DEFAULT_SFX: Record<SfxKey, string> = {
  ...
  [SFX.hallucinations.attack01]: url('/assets/sounds/hallucinations/hallucination_attack_01.wav'),
  [SFX.hallucinations.attack02]: url('/assets/sounds/hallucinations/hallucination_attack_02.wav'),
  [SFX.hallucinations.attack03]: url('/assets/sounds/hallucinations/hallucination_attack_03.wav'),
  [SFX.hallucinations.attack04]: url('/assets/sounds/hallucinations/hallucination_attack_04.wav'),
  [SFX.hallucinations.attack05]: url('/assets/sounds/hallucinations/hallucination_attack_05.wav'),
  [SFX.hallucinations.nearby]: url('/assets/sounds/hallucinations/hallucination_nearby.wav'),
  [SFX.hallucinations.manifest]: url('/assets/sounds/hallucinations/hallucination_manifest.wav'),
